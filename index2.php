...
if (isset($_POST['filter'])) {
  ...
  $data_barang = select("SELECT * FROM barang WHERE tanggal BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id_barang DESC LIMIT $awalData, $jumlahDataPerHalaman");
  
  // Hitung ulang jumlah data untuk filter
  $jumlahData = count(select("SELECT * FROM barang WHERE tanggal BETWEEN '$tgl_awal' AND '$tgl_akhir'"));
  $jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
} else {
